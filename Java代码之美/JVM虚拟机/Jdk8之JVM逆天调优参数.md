...
点击我们的测试类，然后点击Edit Configurations

![](http://yanxuan.nosdn.127.net/e4fdbe9d4ab27d525f028c49fed3e078.png)

点击VM options即可，这里就是我们的JVM的启动配置

![](/Users/bigkang/Library/Application Support/typora-user-images/image-20200529171853203.png)
...
默认值   -1  表示获取当前服务器的逻辑CPU个数，如2核2线程，则为 2 * 2 = 4 ，依此类推
